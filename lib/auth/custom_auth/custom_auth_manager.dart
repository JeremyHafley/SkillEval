...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    skillEvalAuthUserSubject.add(
      SkillEvalAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SkillEvalAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SkillEvalAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SkillEvalAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    skillEvalAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
